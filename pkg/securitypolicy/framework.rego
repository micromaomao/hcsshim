...
# Default to {} if parameters not provided.
raw_fragment_parameters_compat(raw_fragment) := raw_fragment.parameters {
    raw_fragment.parameters
} else := {}
...
check_fragment(raw_fragment, framework_version) := fragment {
    ...
    fragment := {
        ...
        # older framework_version, since it is restrictive.
        "parameters": raw_fragment_parameters_compat(raw_fragment),
